...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card card-body blur shadow-blur  ms-4 mt-n6">
                <section class="pt-3">
                    <div class="container">
                        ...
                        @foreach ($kegiatans as $data)
                            <div class="row py-4">
                                <div class="col-lg my-auto py-3">
                                    ...
                                    <a href="{{ url('/kegiatan/' . $data->id) }}"
                                        class="text-primary icon-move-right">Baca
                                        Selengkapnya
    ...
    <div class="col-md-4">
        <div class="card card-body blur shadow-blur  me-4 mt-n6">
            <section class="pt-3">
                <div class="container">
                    <div class="row">
