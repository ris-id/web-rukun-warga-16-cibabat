...
@section('content')
    <div class="container pb-5">
        ...
        <div class="card p-4">
            <form action="{{ route('strukturOrganisasi.update', $strukturOrganisasi->id) }}" method="POST"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="bendahara" class="form-control"
                                value="{{ $strukturOrganisasi->bendahara }}">
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="keamanan" class="form-control"
                            value="{{ $strukturOrganisasi->keamanan }}">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Pelayanan Masyarakat</strong>
                        <input type="text" name="pelayanan_masyarakat" class="form-control"
                            value="{{ $strukturOrganisasi->pelayanan_masyarakat }}">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Pemuda Olahraga</strong>
                        <input type="text" name="pemuda_olahraga" class="form-control"
                            value="{{ $strukturOrganisasi->pemuda_olahraga }}">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Kesehatan Masyarakat</strong>
                        <input type="text" name="kesehatan_masyarakat" class="form-control"
                            value="{{ $strukturOrganisasi->kesehatan_masyarakat }}">
                    </div>
                </div>
